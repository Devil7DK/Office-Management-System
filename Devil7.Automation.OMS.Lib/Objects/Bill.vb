...
#Region "Constructors"
        Sub New(ByVal ID As Integer, ByVal SerialNo As String, ByVal [Date] As Date, ByVal Sender As Sender, ByVal Receiver As Receiver, ByVal Services As List(Of Service))
            Me.ID = ID
