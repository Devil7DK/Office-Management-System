...
#Region "Form Events"
        Private Sub frm_ClientAddEdit_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
            ...
            If Mode = Enums.DialogMode.Edit AndAlso ID > -1 Then
                ...
                txt_TradeName.Text = Client.TradeName
