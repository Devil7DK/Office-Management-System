...
Namespace Database
    Module Connection
        ...
        Sub LoadConnection()
            Dim ConnectionString As String = String.Format("Server={0};Database={1};User Id={2};Password={3};Application Name=Office Management System;Pooling={4};MultipleActiveResultSets=true;",
