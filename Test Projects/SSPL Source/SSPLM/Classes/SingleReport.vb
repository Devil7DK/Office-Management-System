...
Public Class SingleReport
    ...
    End Sub
    Sub Print()
        Dim P As New D7.Reporter(ReportNumber, FullName & vbNewLine & Address.Replace(",,", ","), DoctorName & vbNewLine & DoctorAddress, ReceivedDate, ReportedDate, AgeSex, HospitalNumber, Report, Image1, Image2, Image3, Image4)
        Dim PD As New PrintDialog
        PD.Document = P.Printer
        PD.AllowSomePages = True
        If PD.ShowDialog = DialogResult.OK Then
            P.PrinterSettings = PD.PrinterSettings
            If P.PrinterSettings.PrintRange = Printing.PrintRange.SomePages Then
                P.Printer.FirstPage = PD.PrinterSettings.FromPage
                P.Printer.LastPage = PD.PrinterSettings.ToPage
            End If
