    ...
    Sub Draw()
        ...
        Using B1 As New Bitmap(Width, Height)
            ...
            Using G As Graphics = Graphics.FromImage(B1)
                ...
                G.DrawString(Value_ & _Symbol, Me.Font, Brushes.Black, New Point(Me.Width / 2 - G.MeasureString(Value_ & _Symbol, Me.Font).Width / 2 + 1, Me.Height / 2 - G.MeasureString(Value_ & "%", Me.Font).Height / 2 + 1))
            End Using
