...
#Region "GSGlassStyleButton UserControl Code"
''' <summary>
''' GSGlassButton Class © 2011 By Manoj Kishor Bhoir
''' </summary>
''' <remarks>Version 1.0.1096.2286</remarks>
<ToolboxItem(True), ToolboxItemFilter("System.Windows.Forms"), ToolboxBitmap("Glassbutton.bmp"), Description("Display the Bar that indicates the Progress of Operation.")> _
<DefaultEvent("Click"), DefaultProperty("Text")> _
Public Class GSGlassButton
...
#Region "GSGlassButton Settings Properties"
    ...
    ''' <summary>
    ''' Get or Set Base Visibility for GSGlassButton
    ''' </summary>
    <Category("GSGlassButton Settings"), _
    Description("Display Glass Style Base for GSGlassButton"), _
    ...
    ''' <summary>
    ''' Get or Set Corner Radius for GSGlassButton
    ''' </summary>
    <Category("GSGlassButton Settings"), _
    Description("Radius of GSGlassButton Corners"), _
    ...
    ''' <summary>
    ''' Enum for Group Position of GSGlassButton
    ''' </summary>
    ...
    ''' <summary>
    ''' Get or Set Group Position for GSGlassButton
    ''' </summary>
    Private _grouppos As MB_GroupPos
    <Category("GSGlassButton Position"), _
    Description("Set the Group Position for GSGlassButton"), _
    ...
    ''' <summary>
    ''' Get or Set Arrow visibility of GSGlassButton
    ''' </summary>
    <Category("GSGlassButton Arrow"), _
    Description("Display Arrow on GSGlassButton"), _
    ...
    End Enum
    ''' <summary>
    ''' Get or Set Split Option for GSGlassButton
    ''' </summary>
    <Category("GSGlassButton Split Settings"), _
    Description("Split GSGlassButton into Two Parts"), _
    ...
    ''' <summary>
    ''' Get or Set Split Distance for GSGlassButton
    ''' </summary>
    <Category("GSGlassButton Split Settings"), _
    Description("Set Split Distance for GSGlassButton"), _
    ...
    ''' <summary>
    ''' Get or Set Button State of GSGlassButton
    ''' </summary>
    <Category("GSGlassButton Appearance"), _
    Description("Keep GSGlassButton Pressed if Clicked"), _
    ...
    ''' <summary>
    ''' Get or Set State of GSGlassButton
    ''' </summary>
    <Category("GSGlassButton Appearance"), _
    Description("Keep GSGlassButton Selected if Focused"), _
    DefaultValue(False), Browsable(True)> _
...
#Region "   Colors"
    ...
    Private _baseColor As Color = Color.Gold
        ...
        Else
            ...
            If (_keeppressed) Then
                ...
                For Each _control As Control In Me.Parent.Controls
                    If _control.Name <> Me.Name And TypeOf (_control) Is GSGlassButton = True Then
                        CType(_control, GSGlassButton)._ispressed = False
                        CType(_control, GSGlassButton).UpdateMouseLeave()
                    End If
                Next
            End If
        End If
...
End Class
''' <summary>
''' MBColor Class for GSGlassButton
''' </summary>
...
End Class
''' <summary>
''' MBMenuRenderer for GSGlassButton ContaxtMenuStrip
''' </summary>
Public Class MBMenuRendere
    ...
    ''' <summary>
    ''' Handles MenuItemBackground for GSGlassButton ContaxtMenuStrip
    ''' </summary>
    ...
    ''' <summary>
    ''' Handles RenderItemImage for GSGlassButton ContaxtMenuStrip
    ''' </summary>
