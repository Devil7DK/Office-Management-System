...
Class ChromeSeparator
    ...
    End Sub
    Property Thichness As Integer = 5
    Property LineColor As Color = Color.Gray
    Protected Overrides Sub ColorHook()
    ...
    Protected Overrides Sub PaintHook()
        G.Clear(BackColor)
        G.DrawLine(New Pen(LineColor, Thichness), New Point(Me.Width / 2, 0), New Point(Me.Width / 2, Me.Height))
    End Sub
End Class