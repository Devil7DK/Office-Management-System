...
#End Region
    Public Shared Sub AttachFormToDesktop(ByRef targetForm As Form)
        ...
        'hWinShell = FindWindow("WorkerW", vbNullString) 'FindWindow("progman", vbNullString)
        ...
        SetParentWindow(targetForm.Handle, GetDesktopWindow) ', hDesktopFileListView) 'Set targetform's parent window to the desktops' file listview
        MsgBox(targetForm.Handle)
