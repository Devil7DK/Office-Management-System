...
#Region "Paintings"
    Sub PaintBackgoundSurface(ByVal sender As Object, ByVal e As System.Windows.Forms.PaintEventArgs)
        ...
        End With
        Dim brGlass As New SolidBrush(Color.FromArgb(GlobalCode.Checks.Check(Opacity), GlassColor.R, GlassColor.G, GlassColor.B))
    ...
    Sub PaintReflectiveBands(ByVal sender As Object, ByVal e As System.Windows.Forms.PaintEventArgs)
        Dim brGlassReflect As New SolidBrush(Color.FromArgb(GlobalCode.Checks.Check(Opacity * 0.5), GlassColor.R, GlassColor.G, GlassColor.B))
    ...
    Sub PaintGlowSurface(ByVal sender As Object, ByVal e As System.Windows.Forms.PaintEventArgs)
        Dim brGlassDarkLinear As New LinearGradientBrush( _
            ...
            Color.FromArgb(GlobalCode.Checks.Check(Opacity * 2.5), GlassColor.R, GlassColor.G, GlassColor.B), _
    ...
    Sub PaintLightSource(ByVal sender As Object, ByVal e As System.Windows.Forms.PaintEventArgs)
        ...
        brLight.CenterColor = Color.FromArgb(GlobalCode.Checks.Check(Opacity * 3), 255, 255, 255)
