...
Public Class BonfireButton
    ...
    Protected Overrides Sub OnPaint(ByVal e As System.Windows.Forms.PaintEventArgs)
        ...
        Dim Dark As Color = Color.FromArgb(20, 135, 195)
        Dim Light As Color = Color.FromArgb(20, 160, 230)
        Select Case ButtonStyle
            Case Style.Blue
                Dark = Color.FromArgb(20, 135, 195)
                Light = Color.FromArgb(20, 160, 230)
            Case Style.Dark
                Dark = Color.FromArgb(45, 45, 45)
                Light = Color.FromArgb(75, 75, 75)
            Case Style.Light
                Color.FromArgb(145, 145, 145)
                Color.FromArgb(170, 170, 170)
            Case Style.Green
                Light = Color.FromArgb(23, 178, 23)
                Dark = Color.FromArgb(1, 156, 1)
            Case Style.Grey
                Light = Color.FromArgb(161, 161, 161)
                Dark = Color.FromArgb(139, 139, 139)
            Case Style.Orange
                Light = Color.FromArgb(253, 163, 23)
                Dark = Color.FromArgb(231, 141, 1)
            Case Style.Purple
                Light = Color.FromArgb(229, 43, 245)
                Dark = Color.FromArgb(207, 21, 223)
        End Select
        If _rounded Then
            G.FillPath(New SolidBrush(Dark), shadowPath)
            G.FillPath(New SolidBrush(Light), RoundRect(mainRect, slope))
        Else
            G.FillRectangle(New SolidBrush(Dark), shadowRect)
            G.FillRectangle(New SolidBrush(Light), mainRect)
        End If
        ...
        If _image Is Nothing Then
            ...
            G.DrawString(Text, Font, Brushes.White, New Rectangle(0, 0, Me.Width, Me.Height), sf)
        Else
            ...
            G.DrawString(Text, Font, Brushes.White, New Rectangle(imageX + imageWidth + 4, 0, Me.Width - (imageX + imageWidth + 4 + 4), Me.Height), sf)
        End If
...
<DefaultEvent("CheckedChanged")> Public Class BonfireCheckbox
    Inherits Control
...
<DefaultEvent("CheckedChanged")> Public Class BonfireRadioButton
    Inherits Control
